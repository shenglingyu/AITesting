...
@SpringBootTest
public class UserAnwserShardingTest {
    @Resource
    ...
    public void test(){
        ...
        UserAnswer userAnswerOne = userAnswerService.getOne(
                Wrappers.lambdaQuery(UserAnswer.class)
                        .eq(UserAnswer::getAppId, 1L)
        );
        System.out.println(userAnswerOne);
        UserAnswer userAnswerTwo = userAnswerService.getOne(
                Wrappers.lambdaQuery(UserAnswer.class)
                        .eq(UserAnswer::getAppId, 2L)
        );
        System.out.println(userAnswerTwo);
    }
}
