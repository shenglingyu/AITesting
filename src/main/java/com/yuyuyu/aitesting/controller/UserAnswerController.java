...
import com.yuyuyu.aitesting.annotation.AuthCheck;
import com.yuyuyu.aitesting.common.BaseResponse;
import com.yuyuyu.aitesting.common.DeleteRequest;
import com.yuyuyu.aitesting.common.ErrorCode;
import com.yuyuyu.aitesting.common.ResultUtils;
import com.yuyuyu.aitesting.constant.UserConstant;
import com.yuyuyu.aitesting.exception.BusinessException;
import com.yuyuyu.aitesting.exception.ThrowUtils;
import com.yuyuyu.aitesting.model.dto.useranswer.UserAnswerAddRequest;
import com.yuyuyu.aitesting.model.dto.useranswer.UserAnswerEditRequest;
import com.yuyuyu.aitesting.model.dto.useranswer.UserAnswerQueryRequest;
import com.yuyuyu.aitesting.model.dto.useranswer.UserAnswerUpdateRequest;
import com.yuyuyu.aitesting.model.entity.App;
import com.yuyuyu.aitesting.model.entity.User;
import com.yuyuyu.aitesting.model.entity.UserAnswer;
import com.yuyuyu.aitesting.model.enums.ReviewStatusEnum;
import com.yuyuyu.aitesting.model.vo.UserAnswerVO;
import com.yuyuyu.aitesting.scoring.ScoringStrategyExecutor;
import com.yuyuyu.aitesting.service.AppService;
import com.yuyuyu.aitesting.service.UserAnswerService;
import com.yuyuyu.aitesting.service.UserService;
...
public class UserAnswerController {
    ...
    public BaseResponse<Long> addUserAnswer(@RequestBody UserAnswerAddRequest userAnswerAddRequest, HttpServletRequest request) {
        ...
        if (! ReviewStatusEnum.PASS.equals(ReviewStatusEnum.getEnumByValue(app.getReviewStatus())) ) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR,"应用审核未通过，无法答题");
        }
        // 填充默认值
        ...
        userAnswerWithResult.setAppId(null);//防止更新appId，解决分库分表的问题
    ...
    public BaseResponse<Long> generateUserAnwserId() {
        return ResultUtils.success(IdUtil.getSnowflakeNextId());//生成全局唯一id
    }
}
