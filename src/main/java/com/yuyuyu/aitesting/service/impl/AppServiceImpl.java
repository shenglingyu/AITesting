package com.yuyuyu.aitesting.service.impl;
...
import com.yuyuyu.aitesting.constant.CommonConstant;
import com.yuyuyu.aitesting.exception.ThrowUtils;
import com.yuyuyu.aitesting.mapper.AppMapper;
...
import com.yuyuyu.aitesting.model.enums.AppScoringStrategeEnum;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            //枚举类校验
            AppScoringStrategeEnum appScoringStrategeEnum = AppScoringStrategeEnum.getEnumByValue(scoringStrategy);
            ThrowUtils.throwIf(appScoringStrategeEnum == null, ErrorCode.PARAMS_ERROR, "评分策略非法");
    ...
    public QueryWrapper<App> getQueryWrapper(AppQueryRequest appQueryRequest) {
        ...
        queryWrapper.eq(ObjectUtils.isNotEmpty(reviewStatus), "sreviewStatus", reviewStatus);
